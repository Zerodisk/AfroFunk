...
|--------------------------------------------------------------------------
| additional for config parameter used by afrofunk application
| the config name will be prefix by afro_
|
| afro_cart_config (enum with 2 type of value)
|    'session'  => using sessions to store shopping cart
